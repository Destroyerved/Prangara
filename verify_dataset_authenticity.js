...
const projectRoot = fs.existsSync(path.join(__dirname, 'datasets', 'data')) ? path.join(__dirname, 'datasets') : (fs.existsSync(path.join(__dirname, 'data')) ? __dirname : path.resolve(__dirname, '..'));
